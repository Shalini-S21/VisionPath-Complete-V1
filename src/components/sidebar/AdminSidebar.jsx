    ...
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800 flex flex-col justify-between p-4 min-h-screen sticky top-0">
      <div className="space-y-6">
        <div className="flex items-center gap-2.5 px-3 py-2">
          ...
          <div>
            ...
            <span className="block text-[10px] font-bold uppercase tracking-wider text-rose-600">Admin Command</span>
          </div>
        </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all ${
                    isActive
                      ? 'bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 border border-rose-200/60 dark:border-rose-900'
      ...
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
        <div className="px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-800/60 flex items-center gap-3 text-xs">
          <div className="w-7 h-7 rounded-full bg-rose-600 text-white font-bold flex items-center justify-center">
